					...
					<div class="container">
						<div class="row">
							<div class="col-md-8 col-md-offset-2 fh5co-section-heading text-center">
								...
								<p>Prova le funzionalità principali di DocuExchange</p>
							</div>
							...
							<div class="col-md-4 col-sm-6 text-center fh5co-text-wrap">
								<div class="fh5co-text">
										<span class="fh5co-icon"><i class="icon-like"></i><i class="icon-dislike"></i></span>
									<h4 class="fh5co-uppercase-sm">Recensisci</h4>
									<p>Fatti conoscere sulla piattaforma valutando gli appunti condivisi sulla piattaforma.</p>
								</div>
							</div>
